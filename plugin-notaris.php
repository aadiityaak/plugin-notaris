    ...
    <div class="table-responsive m-3">
        <div class="mb-2 row mx-0">
            ...
            <div class="col-sm-7 text-sm-end text-right">
                ...
                <div class="btn-group ms-md-2 text-right" role="group" aria-label="Basic example">
                    ...
                    <a href="?status_post=archive" type="button" class="btn text-white <?php echo $class_archive; ?>">Archive</a>
                </div>
            </div>
        </div>
        <table class="table table-striped">
            ...
            <tbody>
                ...
                if (isset($_GET['status_post']) && $_GET['status_post'] == 'archive') {
                    $args['meta_query'][] = array(
                        'key' => 'status_post',
                        'value' => ['archive'],
                        'compare' => 'IN' // Opsional, '=' adalah default value dari 'compare'
                    );
                } else {
                    $args['meta_query'][] = array(
                        'key' => 'status_post',
        ...
        title="Dibayar Rp. ' . number_format($dibayar, 2, ',', '.') . '<br><b>Kekurangan Rp. ' . number_format(($total_biaya - $dibayar), 2, ',', '.') . '</b>">Rp. ' . number_format($total_biaya, 2, ',', '.') . '</a>' : '';
                            ...
                            <td class="text-end">
                                <div class="text-end btn-group">
                                    <a class="btn btn-info btn-sm text-white" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Job Desk" href="<?php echo get_site_url(); ?>/jobdesk/?post_id=<?php echo $post->ID; ?>">
