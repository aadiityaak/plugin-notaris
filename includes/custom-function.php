    ...
    if ($column == 'draft_kerja') {
        ...
        if(is_array($kerja_value)){
            foreach($kerja_value as $val){
                ...
                echo 'data-bs-toggle="tooltip" data-bs-html="true" data-bs-title="<small>Dikerjakan oleh</small> '.$user_nama.' - '.$jabatan.' <br><span>'.$tgl_mulai.' - '.$tgl_selesai.'</span>"';
                echo '>';
    ...
    <div class="row">
        <div class="col-md-4 mb-3 mb-sm-0">
            ...
            <div class="card-body">
                ...
                Tanggal Order: <?php echo $tanggal_order ?>
                </p>
            </div>
            </div>
        </div>
                        ...
                        if ( $the_query->have_posts() ) {
                            ...
                            <?php
                                while ( $the_query->have_posts() ) {
                                    ...
                                    <td><span><?php echo $tanggal_selesai ?></span>
...
function jobdesk_shortcode($atts) {
    ...
    // Query untuk mendapatkan daftar post type 'job_desk'
    $query_args = array(
        'post_type' => 'job_desk',
    ...
    if ($query->have_posts()) {
        ...
        echo '<th scope="col">Pekerjaan</th>';
        echo '<th scope="col">Kategori</th>';
        echo '<th scope="col">Staff</th>';
        echo '<th scope="col">Mulai</th>';
        echo '<th scope="col">Selesai</th>';
        ...
        while ($query->have_posts()) {
            ...
            echo '<td>' . get_post_meta($post_id, 'job_desk_start', true) . '</td>';
        ...
        // Pagination
        // Pagination dengan style Bootstrap 5
        $big = 999999999; // Unique number for pagination
        ...
        if (!empty($pagination)) {
            ...
            foreach ($pagination as $page_link) {
                // Menambahkan kelas 'page-item' dan 'page-link' dari Bootstrap 5
